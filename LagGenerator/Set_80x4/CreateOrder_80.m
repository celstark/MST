function good = CreateOrder_80()

%{

CS 6/2/23
- Modified from CreateOrder_Copt2
- Goal is to create something suitable for an fMRI experiment that focuses
our trial types more heavily on lures.  So, 0 novel foils, 100 lures, 60
repeats and therefore 160 1sts.
- Lags here set to be from 6-80

CS 6/26/23
- Setup for the 320 being split into 4 runs of 80 each
...
ergo 100 trials total

we run lags of 2-30 in here
...
min_lag = 6; % For non-zero, what's the min gap?
max_lag = 80; % For non-zero, what's the max gap?
